...
with st.sidebar:
    start_airport = st.selectbox('Select a Departure Airport', airports['Name'], index=airports[airports['Name'] == 'OR Tambo International Airport'].index[0], default='OR Tambo International Airport')
